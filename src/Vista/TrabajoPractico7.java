 ...
 * @author vanne
 */
public class TrabajoPractico7 extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public TrabajoPractico7() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrabajoPractico7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrabajoPractico7().setVisible(true);
            }
        });
    }
